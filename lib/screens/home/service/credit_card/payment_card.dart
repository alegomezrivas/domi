import 'package:domi/screens/home/service/credit_card/my_strings.dart';
...
class CardUtils {
  ...
  static Widget? getCardIconFromFranchise(String franchise) {
    String img = "";
    Icon? icon;
    if (franchise.contains("master")) {
      img = 'mastercard.png';
    }
    ...
    if (franchise.contains("visa")) {
      img = 'visa.png';
    }

    if (franchise.contains("verve")) {
      img = 'verve.png';
    }

    if (franchise.contains("american")) {
      img = 'american_express.png';
    }

    if (franchise.contains("discover")) {
      img = 'discover.png';
    }

    if (franchise.contains("jcb")) {
      img = 'jcb.png';
    }
